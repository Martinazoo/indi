...
public slots:
  ...
  protected:
	...
	glm::mat4  modelTransformTerra();
	glm::mat4  modelTransformMar();
    glm::mat4  modelTransformMoll();

	void modelTransformDebug(glm::vec3 pos);

    virtual glm::mat4 modelTransformFar1() = 0;
    virtual glm::mat4 modelTransformFar2() = 0;
    virtual glm::mat4 modelTransformVaixell() = 0;
	//--------------------------------------------
